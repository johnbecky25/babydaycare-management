   ...
   <body>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3" Id="contact">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3" style="color:blue;padding-top: 60px;">“Thank you for Enrolling ur child Blessings Daycare centre. Your Enrollment no is <?php echo $_SESSION['enrollnum'];?>”</h3>
